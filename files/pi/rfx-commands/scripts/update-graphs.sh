...
if [ ${donow} -eq 1 ] ; then
	curl -s "http://localhost:8080/rrdchart.png?&items=T_52_8700_last,T_NU_last,T_50_0700_last,T_50_7500_last,T_50_AC00_last,T_50_3B00_last&period=D&w=1024&h=442" > ${tmpfile}
