...
if [ ${donow} -eq 1 ] ; then
	curl -s "http://localhost:8080/rrdchart.png?&items=T_NU_last,T_52_C700_last,T_50_0700_last,T_52_B700_last,T_50_C600_last,T_50_3D00_last,T_52_A700_last&period=D&w=1024&h=442" > ${tmpfile}
